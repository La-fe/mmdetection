...
#############################  修改   #####################################
dt_path = "/home/remo/Desktop/cloth_flaw_detection/Results/result_19_val.json"
##########################################################################
...
# 生成 ground_truth
# val = []
# f = open('/home/remo/Desktop/cloth_flaw_detection/Dataset/COCO_format/val_balance.txt','r')
